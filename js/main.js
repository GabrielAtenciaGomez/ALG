jQuery(document).ready(function ($) {
  ...
  $('.portfolio-flters-elec li').on('click', function () {
    $(".portfolio-flters-elec li").removeClass('filter-active');
  ...
  // Porfolio isotope and filter infrastructura
  var portfolioIsotope2 = $('.portfolio-container2').isotope({
    itemSelector: '.portfolio-item2',
    layoutMode: 'fitRows'
  });

  $('.portfolio-flters-inf li').on('click', function () {
    $(".portfolio-flters-inf li").removeClass('filter-active');
    $(this).addClass('filter-active');
